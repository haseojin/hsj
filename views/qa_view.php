  <div id="main">
    ...
    <table class="type08">
      ...
      <tbody>
        <tr><td colspan="3"><?= $lt->contents?></td></tr>
      </tbody>
    </table>
  ...
  <form name="paging">
    ...
    <td nowrap="" class="m-tcol-c filter-30">|</td><a href="javascript:qanda_page_move('1','modify','<?=$lt->idx?>','<?=$lt->pwd?>');">수정</a>
    <td nowrap="" class="m-tcol-c filter-30">|</td><a href="javascript:qanda_page_move('1','delete','<?=$lt->idx?>','<?=$lt->pwd?>');">삭제</a>
  </form>
